...
Insert into COUNTRY values(18,'China TaiPei',886);
...
Insert into COUNTRY values(25,'Italy',39);
--MEDAL
...
insert into PARTICIPANT values(0,'Ricky','Rubio','Spain','El Masnou, Catalonia, Spain',TO_DATE(' 1990/10/21','yyyy/mm/dd hh24:mi:ss'));
insert into USER_ACCOUNT values(User_account_id.nextval,'Ricky','GUEST',2,null);

insert into PARTICIPANT values(1,'Nikola','Mirotic','Spain','Titograd, SR Montenegro,Yugoslavia',TO_DATE('1991/11/02','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Nikola','GUEST',2,null);

insert into PARTICIPANT values(2,'Pau','Gasol','Spain','Barcelona, Spain
',TO_DATE(' 1980/7/6','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Pau','GUEST',2,null);

insert into PARTICIPANT values(3,'Rudy','Ferandez','Spain','Palma de Mallorca, Spain
',TO_DATE(' 1985/4/4','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Rudy','GUEST',2,null);

insert into PARTICIPANT values(4,'Jose','Calderon','Spain','Villanueva de la Serena, Spain
',TO_DATE(' 1981/9/28','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Jose','GUEST',2,null);

insert into PARTICIPANT values(5,'Willy','Hernangomez','Spain','Madrid, Spain
',TO_DATE(' 1994/5/27','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Willy','GUEST',2,null);

insert into PARTICIPANT values(6,'Sergio','Scariolo','Italy','Brescia, Italy',TO_DATE(' 1961/4/1','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Sergio','SS',1,null);

insert into PARTICIPANT values(7,'Patty','Miles','Australia','Canberra, Australia
',TO_DATE(' 1988/8/11','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Patty','GUEST',2,null);

insert into PARTICIPANT values(8,'Andrew','Bogut','Australia','Melbourne, Victoria',TO_DATE(' 1984/11/28','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Andrew','GUEST',2,null);

insert into PARTICIPANT values(9,'Joe','Ingles','Australia','Adelaide, South Australia',TO_DATE(' 1987/10/2','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Joe','GUEST',2,null);

insert into PARTICIPANT values(10,'Matthew','Dellavedova','Australia','Maryborough, Victoria',TO_DATE(' 1990/9/8','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Matthew','GUEST',2,null);

insert into PARTICIPANT values(11,'Ryan','Broekhoff','Australia','Melbourne, Victoria
',TO_DATE(' 1990/8/23','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Ryan','GUEST',2,null);

insert into PARTICIPANT values(12,'Chris','Goulding','Australia','Launceston, Tasmania',TO_DATE(' 1988/10/24','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Chris','GUEST',2,null);

insert into PARTICIPANT values(13,'Aron','Baynes','Australia','Gisborne, New Zealand',TO_DATE(' 1986/12/9','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Aron','GUEST',2,null);

insert into PARTICIPANT values(14,'Andrej','Lemanis','Australia','Melbourne, Victoria',TO_DATE(' 1969/3/18','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Andrej','AL',1,null);

insert into PARTICIPANT values(15,'Jimmy','Butler','U.S.A','Houston, Texas,U.S.',TO_DATE(' 1989/9/14','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Jimmy','GUEST',2,null);

insert into PARTICIPANT values(16,'Kevin','Durant','U.S.A','Suitland, Maryland, U.S.',TO_DATE(' 1988/9/29','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Kevin','GUEST',2,null);

insert into PARTICIPANT values(17,'DeAndre','Jordan','U.S.A','Houston, Texas,U.S.',TO_DATE(' 1988/7/21','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'DeAndre','GUEST',2,null);

insert into PARTICIPANT values(18,'Kyle','Lowry','U.S.A','Philadelphia, Pennsylvania, U.S.',TO_DATE(' 1986/3/25','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Kyle','GUEST',2,null);

insert into PARTICIPANT values(19,'Harrison','Barnes','U.S.A','Ames, Iowa, U.S.',TO_DATE(' 1992/5/30','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Harrison','GUEST',2,null);

insert into PARTICIPANT values(20,'Kyrie','Irving','U.S.A','Melbourne, Australia',TO_DATE(' 1992/3/23','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Kyrie','GUEST',2,null);

insert into PARTICIPANT values(21,'Mike','Krzyzewski','U.S.A','Chicago, Illinois',TO_DATE(' 1947/2/13','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Mike','MK',1,null);

insert into PARTICIPANT values(22,'Milos','Teodosic','Siberia','Valjevo, Yugoslavia',TO_DATE(' 1987/3/19','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Milos','GUEST',2,null);

insert into PARTICIPANT values(23,'Simonovi?','Marko','Siberia','Pri?tina, SR Serbia, SFR Yugoslavia',TO_DATE(' 1986/5/30','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Simonovi?','GUEST',2,null);

insert into PARTICIPANT values(24,'Bogdanovi?','Bogdan','Siberia','Belgrade, Serbia, FR Yugoslavia
',TO_DATE(' 1992/8/18','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Bogdanovi?','GUEST',2,null);

insert into PARTICIPANT values(25,'Markovi?','Stefan','Siberia','Belgrade, SR Serbia,
SFR Yugoslavia
',TO_DATE(' 1988/4/25','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Markovi?','GUEST',2,null);

insert into PARTICIPANT values(26,'Joki?','Nikola','Siberia','Sombor, Serbia, FR Yugoslavia
',TO_DATE(' 1995, February 19','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Joki?','GUEST',2,null);

insert into PARTICIPANT values(27,'Aleksandar','?or?evi?','Siberia','Belgrade, SR Serbia,
...
insert into PARTICIPANT values(28,'Long','Ma','China','Anshan, Liaoning, China
',TO_DATE(' 1988/10/20','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Long','GUEST',2,null);

insert into PARTICIPANT values(29,'Xiaoxia','Li','China','Anshan, Liaoning, China',TO_DATE('1988/01/16','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Xiaoxia','GUEST',2,null);

insert into PARTICIPANT values(30,'Ai','Fukuhara','Japan','Sendai, Japan',TO_DATE(' 1988/11/1','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Ai','GUEST',2,null);

insert into PARTICIPANT values(31,'Ning','Ding','China','Daqing, Heilongjiang, China
',TO_DATE(' 1990/6/20','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Ning','GUEST',2,null);

insert into PARTICIPANT values(32,' June','Mizutani','Japan','Iwata, Shizuoka, Japan
',TO_DATE(' 1989/6/9','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,' June','GUEST',2,null);

insert into PARTICIPANT values(33,'Guoliang','Liu','China','Xinxinag,Henan,China',TO_DATE(' 1976,January 10','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Guoliang','GL',1,null);

insert into PARTICIPANT values(34,'Murakami','Yasukazu','Japan','Hiroshima Prefecture Onomichi',TO_DATE(' 1957/12/9','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Murakami','MY',1,null);

insert into PARTICIPANT values(35,'Linghui','Kong','China','Harbin,?Heilongjiang,?China',TO_DATE(' 1975/10/18','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Linghui','LK',1,null);

insert into PARTICIPANT values(36,'Sayka','Hirano','Japan','Kanuma, Tochigi, Japan',TO_DATE('1985,March 24','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(40,'Junhong','Jing','China','Shanghai, China',TO_DATE(' 1968/10/13','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(43,'Jike','Zhang','China','Qingdao, China',TO_DATE(' 1988, February 16','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(46,'Hao','Wang','China','Changchun, China',TO_DATE(' 1983/12/15','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(48,'Kasumi','Ishikawa','Japan','Yamaguchi, Yamaguchi, Japan',TO_DATE(' 1993/2/23','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Kasumi','GUEST',2,null);

insert into PARTICIPANT values(49,'Ma','Lin','China','Shenyang, China',TO_DATE(' 1980/02/19','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Ma','GUEST',2,null);

insert into PARTICIPANT values(50,'Jan-Ove','Waldner','Sweden','Stockholm, Sweden',TO_DATE(' 1965/10/3','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Jan-Ove','GUEST',2,null);

insert into PARTICIPANT values(51,'J?rgen','Persson','Sweden','Halmstad, Sweden',TO_DATE(' 1965/10/3','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'J?rgen','GUEST',2,null);

insert into PARTICIPANT values(52,'Liqin','Wang','China','Shanghai, China',TO_DATE('  1978/6/18','yyyy/mm/dd hh24:mi:ss'));
...
insert into USER_ACCOUNT values(User_account_id.nextval,'Dimitrij1','GUEST',2,null);
...
insert into PARTICIPANT values(56,'Werner','Schlager','Austria','Wiener Neustadt, Austria',TO_DATE(' 1972/9/28','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Werner','GUEST',2,null);

insert into PARTICIPANT values(57,'Martha','Komu','Austria','Austria',TO_DATE(' 1972/9/28','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Martha','GUEST',2,null);

insert into PARTICIPANT values(58,'Robert','Gardos','Austria','Budapest, Hungary',TO_DATE(' 1979/1/16','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(60,'Yining','Zhang','China','Beijing, China',TO_DATE(' 1981/10/5','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Yining','GUEST',2,null);

insert into PARTICIPANT values(61,'Nan','Wang','China','Fushun, China',TO_DATE(' 1981/10/5','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Nan','GUEST',2,null);

insert into PARTICIPANT values(62,'Guo','Yue','China','Anshan, Liaoning, China
...
insert into USER_ACCOUNT values(User_account_id.nextval,'Kim1','GUEST',2,null);

insert into PARTICIPANT values(65,'Kim','Taek Soo','North Korea',' South Korea',TO_DATE(' 1968/6/4','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Kim2','KT',1,null);

insert into PARTICIPANT values(66,'Qi','Chen','China','Nantong, China',TO_DATE(' 1981/10/5','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Qi','GUEST',2,null);

insert into PARTICIPANT values(67,' Kong-wah','Chan','Hong Kong China','Guangdong,China',TO_DATE(' 1961/08/31','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,' Kong-wah',' C',1,null);

insert into PARTICIPANT values(68,'Chak Ko','Lai','Hong Kong China','?Foshan, Guangdong, China',TO_DATE(' 1976/5/10','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Chak Ko','GUEST',2,null);

insert into PARTICIPANT values(69,'Ching','Li','Hong Kong China','Doumen,?Zhuhai, Guangdong, China',TO_DATE(' 1975/3/7','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(72,'Jianfeng','Niu','China','Baoding,?Hebei,China',TO_DATE(' 1981/10/5','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(75,'Djokovic','Novak','Serbia','Belgrade, SR Serbia
',TO_DATE(' 1987/5/22','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Djokovic','GUEST',2,null);

insert into PARTICIPANT values(76,'Gonz芍lez','Fernando','Chile','Santiago, Chile',TO_DATE(' 1980/7/29','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Gonz芍lez','GUEST',2,null);

insert into PARTICIPANT values(77,'Nadal','Rafael','Spain','Manacor, Mallorca, Spain',TO_DATE(' 1986/6/3','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Nadal','GUEST',2,null);

insert into PARTICIPANT values(78,'Blake','James','U.S.A','Yonkers, New York, United States',TO_DATE(' 1979/12/28','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Blake','GUEST',2,null);

insert into PARTICIPANT values(79,'Williams','Serena','U.S.A','Michigan, United States',TO_DATE(' 1987/5/25','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Williams','GUEST',2,null);

insert into PARTICIPANT values(80,'Williams','Venus','U.S.A','Lynwood, California, U.S.',TO_DATE(' 1978/5/25','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Williams1','GUEST',2,null);

insert into PARTICIPANT values(81,'Garrigues','Anabel','Spain','Valencia, Spain',TO_DATE(' 1977/5/21','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Garrigues','GUEST',2,null);

insert into PARTICIPANT values(82,'Pascual','Virginia','Spain','Madrid, Spain
',TO_DATE(' 1977/5/22','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Pascual','GUEST',2,null);

insert into PARTICIPANT values(83,'Yan','Zi','China','Chengdu, Sichuan',TO_DATE(' 1977/5/23','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(85,'Bondarenko','Alona','Ukraine','Kryvyi Rih, Ukraine SSR, Soviet Union',TO_DATE(' 1997/5/25','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Bondarenko','GUEST',2,null);

insert into PARTICIPANT values(86,'Kateryna','Bondarenko','Ukraine','Kryvyi Rih, Ukraine SSR, Soviet Union',TO_DATE(' 1989/5/29','yyyy/mm/dd hh24:mi:ss'));
...
insert into USER_ACCOUNT values(User_account_id.nextval,'Kim3','GUEST',2,null);

insert into PARTICIPANT values(91,'Maharu','Yoshimura','Japan','Ibaraki Prefecture, Japan',TO_DATE(' 1993/8/3','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Maharu','GUEST',2,null);

insert into PARTICIPANT values(92,'Chih-Yuan','Chuang','China TaiPei','Kaohsiung, Taiwan',TO_DATE(' 1981/4/2','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Chih-Yuan','GUEST',2,null);

insert into PARTICIPANT values(93,'jiing','xu','China TaiPei','Liaoning,China',TO_DATE(' 1968/1/8','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(96,'Yuxiang','Li','China','China',TO_DATE(' 1964/8/13','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Yuxiang','GUEST',2,null);

insert into PARTICIPANT values(97,'Dmitry','Mazunov','Russia','Nizhny Novgorod,Soviet Union',TO_DATE(' 1971/5/12','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Dmitry','GUEST',2,null);

insert into PARTICIPANT values(98,'Alexey','Smirnov','Russia','Russia',TO_DATE(' 1977/10/9','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Alexey','GUEST',2,null);

insert into PARTICIPANT values(99,'Nikolay','Kharitonov','Russia','Rezino, Novosibirsk Oblast, Soviet Union',TO_DATE(' 1948/10/30','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Nikolay','NK',1,null);

insert into PARTICIPANT values(100,'Bo','Persson','Sweden','Sweden',TO_DATE(' 1955/10/30','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Bo','BP',1,null);

insert into PARTICIPANT values(101,'MURRAY','Andy','United Kingdom','Glasgow, Scotland, UK',TO_DATE(' 1987/5/15','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'MURRAY','GUEST',2,null);

insert into PARTICIPANT values(102,'Federer','Roger','Switzerland','Basel, Switzerland',TO_DATE(' 1981/8/8','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(104,'Hradeck芍','Lucie','Czech Republic','Prague, Czechoslovakia',TO_DATE(' 1985/5/21','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Hradeck芍','GUEST',2,null);

insert into PARTICIPANT values(105,'Hlav芍?kov芍','Andrea','Czech Republic','Plze防, Czechoslovakia',TO_DATE(' 1986/8/10','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Hlav芍?kov芍','GUEST',2,null);

insert into PARTICIPANT values(106,'Petrova','Nadia','Russia','Moscow, Soviet Union',TO_DATE(' 1982/6/8','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Petrova','GUEST',2,null);

insert into PARTICIPANT values(107,'Kirilenko','Maria','Russia','Moscow, Russia SFSR, Soviet Unionn',TO_DATE(' 1987/1/25','yyyy/mm/dd hh24:mi:ss'));
...
','U.S.A','Durban, South Africa',TO_DATE(' 1976/8/21','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Huber','GUEST',2,null);

insert into PARTICIPANT values(109,'Raymond','Lisa','U.S.A','Norristown, Pennsylvania, United States',TO_DATE(' 1973/8/10','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Raymond','GUEST',2,null);

insert into PARTICIPANT values(110,'Nishikori','
Kei','Japan','Matsue, Shimane, Japan',TO_DATE(' 1989/12/29','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Nishikori','GUEST',2,null);

insert into PARTICIPANT values(111,'?af芍?ov芍','Lucie','Czech Republic','Brno, Czechoslovakia',TO_DATE(' 1987/2/4','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'?af芍?ov芍','GUEST',2,null);

insert into PARTICIPANT values(112,'Str?cov芍','Barbora','Czech Republic','Plze防, Czechoslovakia',TO_DATE(' 1986/3/28','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Str?cov芍','GUEST',2,null);

insert into PARTICIPANT values(113,'Vesnina','Elena','Russia','Lviv, Ukraine SSR, Soviet Union',TO_DATE(' 1986/8/10','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Vesnina','GUEST',2,null);

insert into PARTICIPANT values(114,'Makarova','Ekaterina','Russia','Moscow, Russia SFSR, Soviet Union',TO_DATE(' 1988/6/7','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Makarova','GUEST',2,null);

insert into PARTICIPANT values(115,'Hingis','Martina','Switzerland','Ko?ice, Czechoslovakia',TO_DATE(' 1980/9/30','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Hingis','GUEST',2,null);

insert into PARTICIPANT values(116,'Bacsinszky','Timea','Switzerland','Lausanne, Switzerland',TO_DATE(' 1989/6/8','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Bacsinszky','GUEST',2,null);

insert into PARTICIPANT values(117,'Mass迆','Nicol芍s','Chile','Vi?a del Mar, Chile',TO_DATE(' 1979/10/10','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Mass迆','GUEST',2,null);

insert into PARTICIPANT values(118,'Fish','Mardy','U.S.A','Edina, Minnesota, U.S.A',TO_DATE(' 1981/12/9','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Fish','GUEST',2,null);

insert into PARTICIPANT values(119,'Gonz芍lez','Fernando','Chile','Santiago, Chile',TO_DATE(' 1980/7/29','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Gonz芍lez1','GUEST',2,null);

insert into PARTICIPANT values(120,'Dent','Taylor','U.S.A','Newport Beach, California, USA',TO_DATE(' 1981/4/24','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Dent','GUEST',2,null);

insert into PARTICIPANT values(121,'Li','Ting','China','Wuhan, Hubei, China',TO_DATE(' 1980/1/5','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Li','GUEST',2,null);

insert into PARTICIPANT values(122,'Sun','Tiantian','China','Zhengzhou, Henan, China',TO_DATE(' 1981/10/12','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Sun','GUEST',2,null);

insert into PARTICIPANT values(123,'Mart赤nez','Conchita','Spain','San Diego, California, U.S.',TO_DATE(' 1972/4/16','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Mart赤nez','GUEST',2,null);

insert into PARTICIPANT values(124,'Pascual','Virginia','Spain','Madrid, Spain
',TO_DATE(' 1973/9/21','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Pascual1','GUEST',2,null);
...
insert into PARTICIPANT values(127,'Asagoe','Shinobu','Japan','Hy身go, Japan',TO_DATE(' 1976/6/28','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Asagoe','AS',1,null);

insert into PARTICIPANT values(128,'Sugiyama','Ai','Japan','Yokohama, Japan',TO_DATE('  1975/7/5','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Sugiyama','GUEST',2,null);

insert into PARTICIPANT values(129,'Daniel','Vallverd迆','Spain','Venezuela',TO_DATE(' 1986/3/17','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(131,'Kei','Nishikori','Japan','Matsue, Shimane, Japan',TO_DATE(' 1989/12/29','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Kei','KN',1,null);

insert into PARTICIPANT values(132,'Chiang Peng','lung','China TaiPei','Penghu, Taiwan',TO_DATE(' 1976/7/24','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Chiang Peng','Cl',1,null);

insert into PARTICIPANT values(133,'Mary','Fern芍ndez','U.S.A','Miami, Florida, U.S.',TO_DATE(' 1971/8/19','yyyy/mm/dd hh24:mi:ss'));
...
insert into USER_ACCOUNT values(User_account_id.nextval,'Dmitry1','DT',1,null);

insert into PARTICIPANT values(136,'Alexandre','Tursunov','Belarus','Minsk, Belarus',TO_DATE(' 1972/12/12','yyyy/mm/dd hh24:mi:ss'));

insert into USER_ACCOUNT values(User_account_id.nextval,'Alexandre1','AT',1,null);

insert into PARTICIPANT values(137,'Ryue','Yang','China','shanghai,China',TO_DATE(' 1972/12/12','yyyy/mm/dd hh24:mi:ss'));
...
insert into PARTICIPANT values(140,'Chih-yuan','Chuang','China TaiPei','Kaohsiung, Taiwan',TO_DATE(' 1981/4/2','yyyy/mm/dd hh24:mi:ss'));
...
Insert into Team values(30,1,'Team Hong Kong China''s Man''ss table tennis(T)',12,2,67);
...
Insert into Team values(80,3,'Team Hong Kong China''s Man''ss table tennis(T)',12,2,67);
...
Insert into EVENT_PARTICIPATION values(3,11,'e');
...
Insert into TEAM_MEMBER values(13,29);
Insert into TEAM_MEMBER values(13,31);
...
Insert into SCOREBOARD values(0,1,9,31,2,2);
Insert into SCOREBOARD values(0,1,10,30,3,3);
Insert into SCOREBOARD values(0,1,11,38,4,null);
...
Insert into SCOREBOARD values(0,3,13,29,1,1);
Insert into SCOREBOARD values(0,3,13,31,1,1);
...
Insert into SCOREBOARD values(1,6,25,39,3,3);
Insert into SCOREBOARD values(1,6,26,47,4,null);
...
Insert into SCOREBOARD values(1,10,38,79,1,1);
...
Insert into SCOREBOARD values(1,10,40,108,3,3);
...
Insert into SCOREBOARD values(2,15,62,41,4,null);
